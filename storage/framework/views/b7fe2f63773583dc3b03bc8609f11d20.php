...
<body class="bg-[#f3f8ec] min-h-screen flex items-center justify-center">
    <div class="flex w-full max-w-6xl mx-auto bg-white shadow-lg rounded-3xl overflow-hidden">
        ...
        <div class="w-1/2 bg-[#f3f8ec] relative hidden md:block">
            <img src="<?php echo e(asset('storage/image 1.png')); ?>" alt="Driver Illustration" class="absolute bottom-0 left-0 w-full max-h-[500px] object-contain">
            <img src="<?php echo e(asset('storage/logo_komposin-removebg-preview.png')); ?>" alt="Logo" class="absolute top-5 left-5 w-36">
        </div>
        ...
        <div class="w-full md:w-1/2 p-10">
            ...
            <p class="text-center text-gray-500 mb-6">
                Tidak punya akun?
                <a href="<?php echo e(route('register')); ?>" class="text-green-700 font-medium hover:underline">Sign up</a>
            </p>
...
<?php /**PATH E:\laragon\www\komposin-v1\resources\views/auth/login.blade.php ENDPATH**/ ?>