  ...
  <div class="container mx-auto text-center">
    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <?php $__currentLoopData = [
            ...
            <?php if(isset($fitur['link'])): ?>
              <a href="<?php echo e($fitur['link']); ?>" class="block bg-green-50 p-6 rounded shadow-md hover:bg-green-100 transition">
                <i class="fas <?php echo e($fitur['icon']); ?> text-4xl text-green-600 mb-4"></i>
                <h3 class="text-xl font-semibold text-green-800"><?php echo e($fitur['title']); ?></h3>
                <p class="mt-2 text-gray-600"><?php echo e($fitur['desc']); ?></p>
              </a>
            <?php else: ?>
  ...
  <div class="container mx-auto text-center">
    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-6 rounded shadow-md">
        ...
        <h3 class="text-xl font-semibold">Judul Artikel <?php echo e($i); ?></h3>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\komposin-v1\resources\views/Pelanggan/landing.blade.php ENDPATH**/ ?>