...
<body class="bg-gray-100">
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white border-r relative">
      <div class="p-6">
        <img src="{{ asset('storage/logo_komposin_dashboardadmin.png') }}" alt="Kompos-IN Logo"  class="mx-auto mb-6" style="max-height: 50px;"/>
        <nav>
          <ul>
            <li class="mb-4">
    ...
    <main class="flex-1 p-6">
      ...
      <header class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center">
          ...
          <div>
            {{-- <p class="text-gray-700 font-semibold">{{ auth()->Admin()->nama}}</p> --}}
        ...
        <form method="POST" action="{{ route('admin.nama.update') }}">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input type="text" value="{{ auth('admin')->user()->nomor_telepon }}" class="w-full px-3 py-2 border rounded bg-gray-100" readonly>
            </div>
          </div>
